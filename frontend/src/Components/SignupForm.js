...
const SignupForm = () => {
    ...
    return (
        ...
        <button type="submit" className="btn btn-primary m-1" >Sign Up</button>
        </div>
        </form>
        ...
        <div className="info-area w-50 p-2">
            ...
            <p>Make sure to keep note of your <b>phone number</b> and <b>password</b> as you will need both when you login.</p>

            <p>When you have entered all of your details, click the <b>"Sign Up"</b> button below the form.</p>

            <p>If you already have an account with Kinsella Dairies, please proceed to the <b>Login</b> page.</p>
        </div>
